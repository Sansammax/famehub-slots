  ...
  return (
    <Link to="/" className="flex items-center gap-2.5 group">
      ...
      <div className="flex flex-col leading-none">
        <span className="font-bold text-[15px] text-foreground tracking-tight">FAMEHUB</span>
        <span className="text-[10px] text-muted-foreground font-medium tracking-wide uppercase">Excelence your skills</span>
      </div>
    </Link>
  );
}